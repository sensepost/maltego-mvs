...
#                    logging.debug(type(self.additionalFields[i][0]))
#                    logging.debug(type(self.additionalFields[i][1]))
#                    logging.debug(type(self.additionalFields[i][2]))
#                    logging.debug(type(self.additionalFields[i][3]))
...
class MaltegoTransform(object):
    ...
    def getVar(self,varName,default=None):
        logging.debug(self.values.keys())
